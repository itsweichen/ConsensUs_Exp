...
;(function($, window, document, undefined) {
  ...
  function buildWalkthrough() {
    ...
    if (step.popup.type !== 'modal' && step.popup.type !== 'nohighlight') {
      ...
      targetElementWidth = step.popup.overlayWidth || targetElement.outerWidth();
      targetElementHeight = step.popup.overlayHeight || targetElement.outerHeight();

      $('<div>')
        .addClass('overlay-hole')
        .height(Math.min(maxHeight, targetElementHeight))
