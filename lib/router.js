...
FlowRouter.route('/:taskId/individual', {
    ...
    action: function() {
        if (FlowRouter.getQueryParam("order") === '1') {
            ...
            BlazeLayout.render('appBody', {main: 'individualPageRevote',footer: 'Footer'});
        }
    }
});
...
FlowRouter.route('/:taskId/example', {
    name: 'groupPageExample',
    action: function() {
        BlazeLayout.render('appBody', {main: 'VisExample', nav:'TaskHeader', footer: 'Footer'});
    }
});
